        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              {tradeStats && tradeStats.active > 0 && (
                <span className="px-2 py-0.5 bg-cyan-500/20 text-cyan-400 text-xs rounded-full">
                  {tradeStats.active} active
                </span>
              )}
            </div>
            <p className="text-gray-400 text-sm">Trade Deals</p>
            <p className="text-3xl font-bold text-white">{tradeStats?.total || 0}</p>
            <p className="text-sm text-green-400 mt-1">{tradeStats?.completed || 0} completed</p>
          </div>
          ...
          >
            ...
            <p className="text-3xl font-bold text-white">
              ${tradeStats ? (tradeStats.totalVolume / 1_000_000).toFixed(1) : '0'}M
            </p>
            <p className="text-sm text-emerald-400 mt-1">
              ${tradeStats ? (tradeStats.pendingVolume / 1_000).toFixed(0) : '0'}K pending
            </p>
          </div>
          ...
          >
            ...
            <p className="text-3xl font-bold text-white">
              ${disputeStats ? (disputeStats.totalValue / 1_000).toFixed(0) : '0'}K
            </p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">${(disputeStats.totalValue / 1_000).toFixed(0)}K value at risk</p>
                </div>
              </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
          ...
          {!tradeStats || tradeStats.total === 0 ? (
            <div className="text-center py-8">
              <Ship className="w-10 h-10 text-gray-600 mx-auto mb-2" />
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-gray-700/50 rounded-lg p-4 text-center">
                  <p className="text-2xl font-bold text-cyan-400">{tradeStats.active}</p>
                  <p className="text-gray-400 text-sm">Active</p>
                </div>
                <div className="bg-gray-700/50 rounded-lg p-4 text-center">
                  <p className="text-2xl font-bold text-green-400">{tradeStats.completed}</p>
                  <p className="text-gray-400 text-sm">Completed</p>
                </div>
                <div className="bg-gray-700/50 rounded-lg p-4 text-center">
                  <p className="text-2xl font-bold text-yellow-400">{tradeStats.disputed || 0}</p>
                  <p className="text-gray-400 text-sm">Disputed</p>
                </div>
                <div className="bg-gray-700/50 rounded-lg p-4 text-center">
                  <p className="text-2xl font-bold text-white">{tradeStats.total}</p>
              ...
              <div className="p-3 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
                <div className="flex items-center justify-between">
                  <span className="text-gray-400 text-sm">Pending Volume</span>
                  <span className="text-cyan-400 font-semibold">
                    ${(tradeStats.pendingVolume / 1_000).toFixed(0)}K
                  </span>
                </div>
              </div>
            </div>
